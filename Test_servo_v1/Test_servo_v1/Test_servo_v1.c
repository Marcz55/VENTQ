...
enum direction movementDirection = north;
...
// gör rörelsemönstret för travet, beror på vilken direction som är satt på movementDirection
...
<<<<<<< Updated upstream
    ...
    { /*
		...
		{
			MakeTrotGait(gaitResolution_g/2);
		}
    }
